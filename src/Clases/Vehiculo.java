...
public class Vehiculo {
    ...
    int id_conductor;
    int id_Producto;
    ArrayList<traileta> trailetas = new ArrayList();
    public Vehiculo() {
    }

    public Vehiculo(int numero_placa, String año, String marca, String tipo_combustible, String modelo, String color, double capa_combustible, double kilomet) {
    ...
    public ArrayList<traileta> getTrailetas() {
        return trailetas;
    }

    public void setTrailetas(ArrayList<traileta> trailetas) {
        this.trailetas = trailetas;
    }
    
    public void addTraileta(traileta traileta_nueva){
        this.trailetas.add(traileta_nueva);
    }
    ...
    public void removeTraileta(int placa){
        for (int i = 0; i < this.trailetas.size(); i++) {
            if (this.trailetas.get(i).numero_placa == placa) {
                trailetas.remove(i);
            }
        }
    }
